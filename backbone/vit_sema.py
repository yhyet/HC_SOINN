...
class Block(nn.Module):
    ...
    def __init__(self, dim, num_heads, mlp_ratio=4., qkv_bias=False, drop=0., attn_drop=0.,
                 drop_path=0., act_layer=nn.GELU, norm_layer=nn.LayerNorm, config=None, layer_id=None, writer=None, device=None):
        super().__init__()
        self.config = config
        ...
        if config.ffn_adapt:
            self.adapter_module = SEMAModules(self.config, layer_id=layer_id, writer=writer, device=device)
...
class VisionTransformer(nn.Module):
    ...
    def __init__(self, global_pool=False, img_size=224, patch_size=16, in_chans=3, num_classes=1000, embed_dim=768, depth=12,
                 ...
                 act_layer=None, weight_init='', tuning_config=None, optim_config=None, writer=None, device=None):
        super().__init__()
        ...
        self.blocks = nn.Sequential(*[
            Block(
                ...
                config=tuning_config, layer_id=i, writer=writer, device=device
            )
